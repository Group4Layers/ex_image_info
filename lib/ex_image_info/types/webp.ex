defmodule ExImageInfo.Types.WEBP do
  ...
  def info(<< @signature_riff, _skip::bytes-size(4), @signature_webp, @signature_vp8, lossy::bytes-size(1), _skip2::bytes-size(4), first::bytes-size(1), next::bytes-size(9), rest::binary >>) do
  ...
  defp parse_lossless(_first, << one::size(8), two::size(8), three::size(8), four::size(8), _rest::binary >> = buf) do
